                      ...
                      <tr>
                        <td style="padding-top: 20px; color: #555555; font-size: 16px; line-height: 1.6;">
                          ...
                          <p style="text-align: center;">
                            <a href="https://new-student-app.vercel.app/reset-password/${encryptedString}" style="background-color: #FFB703; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;">Reset Password</a>
                          </p>
                          <p>If the button above doesn't work, you can copy and paste the following link into your browser:</p>
                          <p style="text-align: center;">https://new-student-app.vercel.app/reset-password/${encryptedString}</p>
